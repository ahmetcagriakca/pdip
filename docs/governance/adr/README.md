...
| [0036](./0036-deprecation-warning-prior-release-check.md) | Automating the warning-bearing-prior-release check for public-API removals | Accepted | testing, ci, quality, governance, api, release |
